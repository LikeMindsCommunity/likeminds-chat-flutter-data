...
CommunityEntity _$CommunityEntityFromJson(Map<String, dynamic> json) =>
    CommunityEntity(
      ...
      pendingMembersCount: (json['pending_members_count'] as num?)?.toInt(),
      pendingChatRoomCount: (json['pending_chatroom_count'] as num?)?.toInt(),
      openReportsCount: (json['open_reports_count'] as num?)?.toInt(),
      chatroomUnseen: (json['chatroom_unseen'] as num?)?.toInt(),
      ...
      clickState: (json['click_state'] as num?)?.toInt(),
      chatroomCount: (json['chatroom_count'] as num?)?.toInt(),
...
Map<String, dynamic> _$CommunityEntityToJson(CommunityEntity instance) =>
    <String, dynamic>{
      ...
      'community_settings': instance.communitySettings,
    };
