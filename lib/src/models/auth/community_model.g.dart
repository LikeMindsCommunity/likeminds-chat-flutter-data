...
Community _$CommunityFromJson(Map<String, dynamic> json) => Community(
      ...
      pendingMembersCount: json['pendingMembersCount'] as int,
      ...
      leaveCommunity: json['leave_community'] as Map<String, dynamic>?,
      ...
      communitySettingRights:
          (json['community_setting_rights'] as List<dynamic>?)
              ?.map((e) => e as Map<String, dynamic>)
              .toList(),
...
Map<String, dynamic> _$CommunityToJson(Community instance) => <String, dynamic>{
      ...
      'pendingMembersCount': instance.pendingMembersCount,
      'date': instance.date,
      'type': instance.type,
